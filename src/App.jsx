  ...
  return (
    <div className="relative min-h-screen bg-[#070516] text-[#f6f4ff] selection:bg-[#7c5cff]/30 selection:text-white">
      ...
      <div className="mobile-cta-bar">
        <a href="#contact" className="flex-1 btn-pill !h-11 !text-[13px] !rounded-xl text-center">
          Book Consultation
        </a>
        <a
          ...
          style={{
            ...
            gap: '6px', flex: 1, height: '44px', borderRadius: '12px',
            fontSize: '13px', fontWeight: 600, textDecoration: 'none',
            background: 'rgba(52,211,153,0.1)', border: '1px solid rgba(52,211,153,0.3)',
            color: '#34d399'
          }}
        >
          <svg style={{ width: 16, height: 16, fill: 'currentColor', flexShrink: 0 }} viewBox="0 0 24 24">
